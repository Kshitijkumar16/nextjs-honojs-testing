		...
		<div className='flex flex-col justify-center items-center mt-8'>
			<div>
				<Image
					src={images.kshitij}
					alt=''
					className='object-cover object-center rounded-full h-[92px] w-[92px]'
				/>
			</div>
			...
			<div className='flex flex-col justify-center items-center'>
				...
				<div className='flex justify-center items-center gap-2 mt-1'>
					...
					<p className='text-white/50 text-[4px]'>⚪</p>
					<p className='text-white/50 b-text'>12 sessions strong</p>
				</div>
			</div>
